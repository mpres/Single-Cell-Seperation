...
def makeGeneRowParam(adata, gene_list, purity_cutoff = 3, total_hit_cutoff=500, std=2, i=4 , GeneScoreParam=None):
    ...
    df_result,gene_purge_list = getGeneVarianceScoresParam(adata,gene_list,len(gene_list),purity_cutoff=purity_cutoff,total_hit_cutoff=total_hit_cutoff,GeneScoreParam=GeneScoreParam)
